...
cp "$CURRENT_DIR/template_dbt/models/staging/stg_orders.sql" "$DBT_PROJECT_DIR/models/staging/stg_orders.sql"
cp "$CURRENT_DIR/template_dbt/models/staging/stg_customers.sql" "$DBT_PROJECT_DIR/models/staging/stg_customers.sql"
cp "$CURRENT_DIR/template_dbt/models/marts/fct_orders.sql" "$DBT_PROJECT_DIR/models/marts/fct_orders.sql"
