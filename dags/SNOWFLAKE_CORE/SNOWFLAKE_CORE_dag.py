...
def load_config(dag_folder):
    config_file = os.path.join(dag_folder, f'SNOWFLAKE_CORE_configuration.yaml')
...
def run_dbt_project():
    dbt_project_dir = os.path.join(os.environ["AIRFLOW_HOME"], "dags", "SNOWFLAKE_CORE_dbt_project")
